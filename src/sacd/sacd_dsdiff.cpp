...
void sacd_dsdiff_t::set_info(uint32_t track_number, const kodi::addon::AudioDecoderInfoTag& info)
{
...
void sacd_dsdiff_t::set_albumart(uint32_t albumart_id, const std::vector<uint8_t>& albumart_data)
{
