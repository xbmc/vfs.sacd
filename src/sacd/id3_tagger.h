...
public:
  ...
  static bool load_info(const std::vector<uint8_t>& buffer, kodi::addon::AudioDecoderInfoTag& info);
  static bool save_info(std::vector<uint8_t>& buffer, const kodi::addon::AudioDecoderInfoTag& info);
