 ...
 * the prev/next entries already!
 */
static inline void __list_add_rcu(struct list_head * newn,
 ...
 */
static inline void list_add_rcu(struct list_head *newn, struct list_head *head)
{
 ...
 * list_for_each_entry_rcu().
 */
static inline void list_add_tail_rcu(struct list_head *newn,
...
static inline void hlist_replace_rcu(struct hlist_node *old,
          struct hlist_node *newn)
{
  struct hlist_node *next = old->next;

  newn->next = next;
  newn->pprev = old->pprev;
//  smp_wmb();
  if (next)
